...
# --- 2. DATABASE SETUP ---
conn = sqlite3.connect('english_guru_v3.db', check_same_thread=False)
c = conn.cursor()
    ...
    with col2:
        ...
        with tab2:
            ...
            if st.button("REGISTER HERO"):
                ...
                else: st.warning("Invite Code: GURU77")
...
# --- 5. MAIN APP (After Login) ---
    ...
    if page == "🏠 Home Base":
        ...
        st.markdown("<div style='text-align:center'><img src='https://img.freepik.com/free-vector/monsters-game-background_23-2148151478.jpg' width='300'></div>", unsafe_allow_html=True)
